...
This Code of Conduct applies within all community spaces of every project under the
[STRATO-DAN](https://github.com/STRATO-DAN) organization, and also applies when an individual is
...
community leaders responsible for enforcement at **opensource@thedubai.ai**. All complaints will
...
Because this Code of Conduct is shared across every public repository under the
[STRATO-DAN](https://github.com/STRATO-DAN) organization, a ban issued under this Code of Conduct
is an **org-wide ban**, not limited to the single repository where the violation occurred — a
temporary or permanent ban applies across all DAN Systems public repositories for its stated
duration. This mirrors the same standard other multi-repo open-source organizations use, so that a
violation in one project cannot simply continue unaddressed in another.
